...
public class Test2 {
  ...
  public void extractWordsStartwithS() {
    List<List<String>> listList =
        Arrays.asList(
            Arrays.asList("venu", "seee", "ssss"), Arrays.asList("jjjj", "kkkkk", "sssss"));
  ...
  public void sortEmployeeBasedOnSalary() {
    EmployeeDTO employee_1 =
        new EmployeeDTO(1, "venu", "90000", "12", "www.google.com", "", "", "");
    EmployeeDTO employee_2 =
        new EmployeeDTO(2, "venu", "20000", "25", "www.google.com", "", "", "");
    EmployeeDTO employee_3 =
        new EmployeeDTO(3, "venu", "30000", "26", "www.google.com", "", "", "");
    EmployeeDTO employee_4 =
        new EmployeeDTO(4, "venu", "40000", "30", "www.google.com", "", "", "");
    EmployeeDTO employee_5 =
        new EmployeeDTO(5, "venu", "50000", "34", "www.google.com", "", "", "");
    ...
    List<EmployeeDTO> sortedById =
        employees.stream().sorted(Comparator.comparing((EmployeeDTO::getId)).reversed()).toList();

    List<EmployeeDTO> sortedBySalary =
        employees.stream()
            .sorted(
                Comparator.comparing(employee -> Integer.valueOf(employee.getEmployee_salary())))
            .toList();
  ...
  public void groupbyExample() {
    List<String> stringListOne =
        Arrays.asList("venu", "ram", "sumanth", "venu", "ele", "jjj", null, null);
    ...
    Map<Boolean, List<String>> result1 =
        stringList.stream().collect(Collectors.partitioningBy(n -> n.length() == 3));
    // result1.forEach((key, value) -> System.out.println("key :" + key + " : value :" + value));
    Map<String, Long> result3 =
        stringList.stream().collect(Collectors.groupingBy(String::valueOf, Collectors.counting()));
    // result3.forEach((key, value) -> System.out.println("key :" + key + " : value :" + value));

    Map<String, Optional<String>> result4 =
        stringList.stream()
            .collect(
                Collectors.groupingBy(
                    String::valueOf, Collectors.maxBy(Comparator.comparing(String::length))));
